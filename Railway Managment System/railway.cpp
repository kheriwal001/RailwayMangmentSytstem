...
public:
    ...
    int phoneNo[6];
    static int age[6];
    static string bp[6];  // Birth Preference
    static int cId[6];
    char arr[100];
    static int pnr;  // Static variable for PNR
    static int n;  // Number of passengers
    ...
    void information()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            while (true)
            {
                cout << "\n Enter the customer ID password: ";
                cin >> cId[i];
                ...
                if (cin.fail())
                {
                    ...
                    cout << "Invalid input. Please enter a valid customer ID (integer)." << endl;
                }
                else
                {
...
public:
    ...
    void trains()
    {
        ...
        case 1:
        {
            ...
            cin >> choice1;
            cout << "\n Enter the AC class in which u want to travel  (1 for 1A, 2 for 2A and 3 for 3A): ";
            cin >> f;
        ...
        case 2:
        {
            ...
            cout << " 1.KOL-897 " << endl;
            cout << "\t20-01-2024  8:00PM  10hrs 3A-Rs.1800 2A-Rs.2600 1A-Rs.4400" << endl;
            cout << " 2.KOL-567 " << endl;
            cout << "\t21-01-2024  10:00PM  15hrs 3AC-Rs.1900 2AC-Rs.2200 1AC-Rs.4800" << endl;
            cout << " 3.KOL-789" << endl;
            cout << "\t22-01-2024  11:00PM  20hrs 3A-Rs.1700 2A-Rs.2100 1A-Rs.4500" << endl;
        ...
        case 3:
        {
            ...
            cout << " 1.PAT-123 " << endl;
            cout << "\t24-01-2024  12:00AM  10hrs 3A-Rs.2200 2A-Rs.3200 1A-Rs.5500" << endl;
            cout << " 2.PAT-345 " << endl;
            cout << "\t25-01-2024  2:00PM 15hrs  3A-Rs.2300 2A-Rs.3400 1A-Rs.5600" << endl;
            cout << " 3.PAT-456" << endl;
            cout << "\t26-01-2024  4:00PM  20hrs  3A-Rs.2400 2A-Rs.3600 1A-Rs.5700" << endl;
        ...
        case 4:
        {
            ...
            cout << " 1.NAG-123 " << endl;
            cout << "\t14-03-2024  12:00AM  10hrs 3AC-Rs.1300 2AC-Rs.1900 1AC-Rs.3400" << endl;
            cout << " 1.NAG-345 " << endl;
            cout << "\t15-03-2024  2:00PM 15hrs  3AC-Rs.1400 2AC-Rs.2000 1AC-Rs.3500" << endl;
            cout << " 1.NAG-456" << endl;
            cout << "\t16-03-2024  4:00PM  20hrs 3AC-Rs.1500 2AC-Rs.2100 1AC-Rs.4200" << endl;
        ...
        case 5:
        {
            ...
            cout << " 1.JAI-123 " << endl;
            cout << "\t17-01-2024  12:00AM  10hrs 3A-Rs.2200 2A-Rs.3200 1A-Rs.5300" << endl;
            cout << " 2.JAI-345 " << endl;
            cout << "\t18-01-2024  2:00PM 15hrs 3A-Rs.2300 2A-Rs.3300 1A-Rs.5400" << endl;
            cout << " 3.JAI-456" << endl;
            cout << "\t19-01-2024  4:00PM  20hrs 3A-Rs.2400 2A-Rs.3500 1A-Rs.5500" << endl;
        ...
        case 6:
        {
            ...
            cout << " 1.MUM-123 " << endl;
            cout << "\t04-09-2024  12:00AM  10hrs  3A-Rs.1500 2A-Rs.2200 1A-Rs.3700" << endl;
            cout << " 2.MUM-345 " << endl;
            cout << "\t05-09-2024  2:00PM 15hrs  3A-Rs.1600 2A-Rs.2300 1A-Rs.3800" << endl;
            cout << " 3.MUM-456" << endl;
            cout << "\t06-09-2024  4:00PM  20hrs  3A-Rs.1700 2A-Rs.2400 1A-Rs.3900" << endl;
